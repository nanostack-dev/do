...
func TestInferServiceName(t *testing.T) {
	...
	is.Equal("github.com/nanostack-dev/do.eagerTest", inferServiceName[eagerTest]())
	is.Equal("*github.com/nanostack-dev/do.eagerTest", inferServiceName[*eagerTest]())
	is.Equal("github.com/nanostack-dev/do.Healthchecker", inferServiceName[Healthchecker]())
}
